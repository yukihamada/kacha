...
struct KAGISetupView: View {
    ...
    private var tokenInputSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            // ヘルプテキスト
            Text("QRコードはKAGIデバイスのNFCタグまたはデバイス設定画面から読み取れます")
                .font(.caption)
                .foregroundColor(.secondary)
        }
    }
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 14) {
                Image(systemName: notificationsGranted ? "bell.badge.fill" : "bell.slash.fill")
                    .font(.title2)
                    .foregroundColor(notificationsGranted ? .accentColor : .secondary)
    ...
    private var completeButton: some View {
        Button {
            ...
            .padding(16)
            .background(inputToken.isEmpty ? Color.gray : Color.accentColor)
...
#Preview {
    KAGISetupView(familyToken: .constant(""))
}
